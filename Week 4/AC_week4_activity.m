...
%%%%%%%%%%
% A1 HERE!
viconOutput2.Properties.VariableDescriptions{1,:}
%%%%%%%%%%
...
% It seems the same? unless I'm missing something..
%%%%%%%%%%
...
%%%%%%%%%%
% A3 HERE!
viconOutput2.Properties.VariableNames{1,1}='Frame';
viconOutput2.Properties.VariableNames{1,2}='Sub_Frame';
...
%%%%%%%%%%
% A4 HERE!
origVarnames = viconOutput2.Properties.VariableNames(1,3:end);
%%%%%%%%%%
...
%%%%%%%%%%
            for ii = 1:8
                viconOutput2.Properties.VariableNames{viconidx+ii} = [interimVarnames{idx}, suffix{ii}];
                % A6a HERE: specify a new index (eg. ii) and its range.
...
viconOutput2 = renamevars(viconOutput2,...
    viconOutput2.Properties.VariableNames,...
    cellfun(@removeJO,viconOutput2.Properties.VariableNames,...
    'UniformOutput', false));
...
function name = removeJO(x)
if isstring(x)
    x = char(x);
end
if strcmpi(x(1:3), 'JO_')
    name = extract('JO_'),;
else 
    name = x;
end
